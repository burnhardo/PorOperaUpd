...
namespace Opera_Beta_x86_Launcher
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (File.Exists(applicationPath + "\\Opera Beta x86\\opera.exe"))
            {
                ...
                if (!File.Exists(applicationPath + "\\Opera Beta x86\\Profile.txt"))
                {
                    ...
                    if (Arguments.Contains("--user-data-dir="))
                    {
                        ...
                        Process.Start(applicationPath + "\\Opera Beta x86\\opera.exe", Arguments3);
                    }
                    else
                    {
                        Process.Start(applicationPath + "\\Opera Beta x86\\opera.exe", Arguments);
                    }
                }
                else
                {
