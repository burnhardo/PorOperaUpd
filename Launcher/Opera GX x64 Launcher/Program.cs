...
namespace Opera_GX_x64_Launcher
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (File.Exists(applicationPath + "\\Opera GX x64\\opera.exe"))
            {
                ...
                if (!File.Exists(applicationPath + "\\Opera GX x64\\Profile.txt"))
                {
                    ...
                    if (Arguments.Contains("--user-data-dir="))
                    {
                        ...
                        Process.Start(applicationPath + "\\Opera GX x64\\opera.exe", Arguments3);
                    }
                    else
                    {
                        Process.Start(applicationPath + "\\Opera GX x64\\opera.exe", Arguments);
                    }
                }
                else
                {
